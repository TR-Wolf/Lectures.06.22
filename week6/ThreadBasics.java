...
//        burgerCooked = false;
//
//        // Creating a Executors.threads.Chef Thread using new Runnable() to create Override.
...
//        });
//
//        // (Afterwards) Create Executors.threads.Chef Thread from a Runnable Class instead.
